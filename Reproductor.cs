...
namespace Biblioteca_de_Peliculas
{
    public partial class Reproductor : Form
    {
        ...
        {
            BtnSordo.BringToFront();
            MtbVolumen.Value = 0;
            MtbVolumen.Visible = false;
        }

        //╔════════════════════════╗
        //║ Botón cancelar volumen ║
        //╚════════════════════════╝
        private void BtnSordo_Click(object sender, EventArgs e)
        {
            BtnVolumen.BringToFront();
            MtbVolumen.Value = 50;
        ...
        public void Abrir(int ruta)
        {
            ...
            {
                case 1:
                    WmpReproductor.URL = (@"C:\Users\Jorge\Downloads\Video.mp4");
                    break;
