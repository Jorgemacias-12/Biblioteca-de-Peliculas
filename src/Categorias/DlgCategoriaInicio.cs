...
{
    public partial class DlgCategoriaInicio : Form
    {
        public DlgCategoriaInicio()
        {
            InitializeComponent();

        }

        private void PtbCerrarDlgCategoriaInicio_Click_1(object sender, EventArgs e)
        {
            Close();
        }
        ...
        private void PtbPeli5_Click(object sender, EventArgs e)
        {
            this.Close();
            DlgReproductor dlgReproductor = new DlgReproductor(5);
            dlgReproductor.Show();
        }
